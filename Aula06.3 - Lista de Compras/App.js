    ...
    return (
      <View style={styles.itemProduto}>
        ...
        <View style={styles.itemOpcoes}>
          <View style={styles.itemOpcoesAlter}>
            <TouchableOpacity onPress={() => decrementarProduto(item.id)} style={styles.itemTerefaDecresQtd}>
              <Text style={styles.itemSimbolo}>-</Text>
            </TouchableOpacity>
            <View style={styles.itemContadorProduto}>
              <Text style={styles.textContadorProduto}>{item.qtd}</Text>
            </View>
            <TouchableOpacity onPress={() => acrescentarProduto(item.id)} style={styles.itemTarefaAcreQtd}>
              <Text style={styles.itemSimbolo}>+</Text>
            </TouchableOpacity>
          </View>
